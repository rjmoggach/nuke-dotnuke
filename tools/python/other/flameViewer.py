...
def init():
    ...
    if fvEnabled == True:
        nuke.menu("Nuke").addCommand(
            "Viewer/FlameViewer/Front", "fvlayer = fv.view('front',fvlayer)", frontKey
        )
        nuke.menu("Nuke").addCommand(
            "Viewer/FlameViewer/Back", "fvlayer = fv.view('back',fvlayer)", backKey
        )
        nuke.menu("Nuke").addCommand(
            "Viewer/FlameViewer/Matte", "fvlayer = fv.view('matte',fvlayer)", matteKey
        )
        nuke.menu("Nuke").addCommand(
            "Viewer/FlameViewer/Result",
            "fvlayer = fv.view('result',fvlayer)",
            resultKey,
        )
