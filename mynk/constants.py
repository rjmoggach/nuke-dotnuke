...
try:
    ...
    MYNK_CHARSET = os.environ.get("MYNK_CHARSET", "utf8")

    # Set the mynk delimiter to be an underscore
    MYNK_DELIMITER = os.environ.get("MYNK_DELIMITER", "_")
    ...
    MYNK_DEVEL = (
        True if os.environ.get("MYNK_DEVEL", False) in ["1", "true", "True"] else False
    )
    LOG.debug("MYNK_DEVEL attribute is {0}".format(MYNK_DEVEL))
